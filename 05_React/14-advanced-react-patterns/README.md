...
## Overview
This module demonstrates reusable architecture patterns used in scalable React systems.
...
- `00-reference.md`
- `src/hocExample.jsx`
- `src/renderPropsExample.jsx`
- `src/compoundComponentsExample.jsx`
- `src/useToggle.js`
- `src/ErrorBoundary.jsx`
- `src/portalExample.jsx`

## Expected Outcome
You should know when to apply each advanced pattern based on flexibility, readability, and maintainability.

<!-- DOCS_UPGRADE_V2026_START -->
## Documentation Upgrade Layer

### Breadcrumb Navigation
[Home](../../README.md) > 05_React > 14-advanced-react-patterns
...
├── src/
│   ├── compoundComponentsExample.jsx
│   ├── ErrorBoundary.jsx
│   ├── hocExample.jsx
│   ├── portalExample.jsx
│   ├── renderPropsExample.jsx
│   └── useToggle.js
├── 00-reference.md
├── README.md
```
...
- `05_React/14-advanced-react-patterns/00-reference.md`
