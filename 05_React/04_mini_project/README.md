...
[Home](../../README.md) > 05_React > 04_mini_project
...
1. How would you scope a React mini-project into vertical slices that can ship independently?
2. Which API contract assumptions must be explicit to support optimistic UI and rollback?
3. How do you define and enforce non-functional budgets (bundle size, TTI, error rate) for the project?
4. What is your strategy for handling empty/loading/error/offline states in all critical screens?
5. How would you prepare a release plan with rollback criteria for this project?

### Production Best Practices Upgrade
- Add project-level ADRs for state architecture, data-fetch strategy, and route/module boundaries.
- Ship with quality gates: lint, unit tests for core flows, and smoke tests for critical routes.
- Instrument user-impacting flows (form submit, fetch retry, navigation) before feature expansion.
- Include a release checklist with rollback triggers and incident ownership.
