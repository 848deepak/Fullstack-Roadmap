...
[Home](../../README.md) > 05_React > 02_practice_problems
...
1. How would you design a progression of React problems from state basics to async orchestration without random jumps?
2. Which rubric do you use to evaluate solutions: correctness, readability, testability, and performance?
3. How can practice tasks expose stale-closure and dependency-array mistakes intentionally?
4. When should a practice solution be refactored into reusable hooks versus kept inline for clarity?
5. How do you prevent learners from memorizing patterns instead of reasoning from state flow and constraints?

### Production Best Practices Upgrade
- Attach acceptance criteria and edge-case checklists to every practice problem.
- Require a baseline test or assertion for each exercise before refactoring for elegance.
- Include at least one debugging-focused problem (render loop, stale effect, race condition) in each batch.
- Maintain post-solution notes: what changed, why it works, and what would fail in production.
