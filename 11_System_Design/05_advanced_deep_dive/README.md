...
[Home](../../README.md) > 11_System_Design > 05_advanced_deep_dive
...
1. How do you choose service boundaries that optimize team autonomy while preserving end-to-end reliability?
2. Compare saga orchestration and choreography for distributed transactions under partial failures.
3. How would you design backpressure strategy across gateways, workers, and storage to prevent cascading collapse?
4. What architecture patterns best support multi-region consistency requirements with low-latency reads?
5. How do you evolve a mature system without violating existing contracts and operational expectations?

### Production Best Practices Upgrade
- Validate advanced architecture changes with progressive rollout and shadow traffic before broad adoption.
- Enforce explicit failure budgets and dependency policies to limit blast radius across service boundaries.
- Use architecture governance that balances standardization with team-level decision autonomy.
- Maintain compatibility contracts for events and APIs with clear versioning and deprecation windows.
- Regularly run game days to verify assumptions about failover, queue recovery, and operational coordination.
