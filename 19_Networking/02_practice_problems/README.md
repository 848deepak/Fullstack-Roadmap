...
[Home](../../README.md) > 19_Networking > 02_practice_problems
...
1. How do you design networking exercises that progress from basic routing to fault-tolerant traffic management?
2. Which scenarios best teach the impact of DNS and connection reuse on latency?
3. How should learners justify routing and retry policy under conflicting reliability goals?
4. What rubric scores operational safety, not only connectivity correctness?
5. How do you incorporate outage-propagation analysis into practice tasks?

### Production Best Practices Upgrade
- Define each problem with latency, availability, and security constraints.
- Include debugging tasks for asymmetric routing, TLS mismatch, and stale DNS behavior.
- Require learners to provide rollback plans for traffic policy changes.
- Evaluate solutions on blast radius containment and observability readiness.
- Continuously update exercises with modern service-mesh and edge-routing patterns.
