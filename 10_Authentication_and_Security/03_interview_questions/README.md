...
[Home](../../README.md) > 10_Authentication_and_Security > 03_interview_questions
...
1. How would you explain the difference between authentication, authorization, and accounting (AAA) in a production API ecosystem?
2. Compare RBAC, ABAC, and ReBAC for a multi-tenant SaaS platform with complex data-sharing rules.
3. How do you design secure login and password-reset flows that resist enumeration, replay, and token theft?
4. What is your strategy for phased rollout of stricter auth controls without causing a large support burden?
5. If logs show suspicious token reuse from multiple geographies, how do you investigate and contain the incident?

### Production Best Practices Upgrade
- Answer interview scenarios with clear threat models, trust boundaries, and measurable risk reduction outcomes.
- Use concrete production narratives (detection, containment, remediation, prevention) to demonstrate mature security reasoning.
- Connect protocol knowledge to operational realities: key management, incident response, and compliance controls.
- Practice explaining trade-offs between friction and security in user authentication journeys.
- Keep structured response templates that include assumptions, controls, telemetry, and rollback options.
