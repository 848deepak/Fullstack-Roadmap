...
[Home](../../README.md) > 18_Backup_and_Recovery > 02_practice_problems
...
1. How do you structure practice problems from basic backup jobs to full disaster-recovery execution?
2. Which scenarios best teach the difference between data durability and service availability?
3. How should learners reason about retention cost versus compliance requirements?
4. What rubric measures quality of recovery plans, not only backup success?
5. How do you simulate realistic restore pressure in practice exercises?

### Production Best Practices Upgrade
- Require each exercise to state RTO/RPO assumptions and acceptance criteria.
- Include drills for corrupted backups, delayed replicas, and missing archive segments.
- Grade solutions on recoverability evidence and operational clarity.
- Use post-drill retrospectives to strengthen weak recovery decision points.
- Evolve scenarios with increasing scale and cross-region dependency complexity.
