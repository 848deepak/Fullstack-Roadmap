...
[Home](../../README.md) > 18_Backup_and_Recovery > 03_interview_questions
...
1. How do you explain RTO/RPO trade-offs when business stakeholders request “near-zero downtime” for all systems?
2. What interview answer demonstrates strong thinking about backup integrity and restore verification?
3. How would you compare active-passive and active-active disaster recovery strategies under budget limits?
4. Which architecture choices most reduce blast radius during data corruption incidents?
5. How do you communicate uncertainty during recovery when telemetry is partially unavailable?

### Production Best Practices Upgrade
- Organize questions around durability, recovery speed, compliance, and operational execution.
- Add follow-ups that test prioritization under outage pressure.
- Include scenarios requiring trade-off articulation between cost and resilience.
- Capture expected high-quality answer signals tied to real production incidents.
- Refresh question sets with current cloud DR and data-protection patterns.
