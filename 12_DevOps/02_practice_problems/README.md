...
[Home](../../README.md) > 12_DevOps > 02_practice_problems
...
1. A practice task asks you to cut CI time by 40%. Which changes do you prioritize without reducing confidence?
2. How would you detect flaky tests versus true regressions in a high-change pipeline?
3. In deployment exercises, how do you decide when to stop rollout automatically?
4. What signals prove a rollback was successful beyond “deployment finished” status?
5. How would you balance security scanning depth with developer iteration speed?

### Production Best Practices Upgrade
- Define each exercise with measurable constraints: build time budget, failure budget, and release confidence threshold.
- Include failure simulation in practice tasks (broken dependency, misconfigured env var, partial deploy failure).
- Require post-exercise analysis of root cause, detection gap, and prevention control.
- Reuse a standard release-readiness checklist across all practice problems.
- Encourage iterative improvements with baseline vs optimized pipeline comparisons.
