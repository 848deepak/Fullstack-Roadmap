...
[Home](../../README.md) > 06_NextJS > 04_mini_project
...
1. How would you scope a Next.js mini project into route-level milestones that ship progressively?
2. What cache invalidation strategy would you select for frequently updated listings and why?
3. How would you protect server actions and route handlers against abuse and accidental overuse?
4. Which fallback behaviors are mandatory when upstream APIs fail during SSR?
5. How would you define release-readiness gates for SEO, performance, and error budgets?

### Production Best Practices Upgrade
- Create project ADRs for rendering policy, data boundaries, and cache invalidation ownership.
- Add smoke tests for critical routes across server render, client navigation, and revalidation paths.
- Track route-level SLOs (TTFB, error rate, stale content tolerance) before feature expansion.
- Include rollback criteria for cache mistakes, broken hydration, and API dependency regressions.
