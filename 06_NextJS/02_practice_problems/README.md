...
[Home](../../README.md) > 06_NextJS > 02_practice_problems
...
1. How would you order practice tasks to teach rendering-mode decisions before optimization tactics?
2. Which rubric do you use to grade a Next.js solution beyond “it works”?
3. How can exercises intentionally surface cache invalidation bugs and hydration mismatch scenarios?
4. When should learners refactor to Server Actions versus keeping explicit API routes?
5. How do you ensure practice outcomes map to real production constraints?

### Production Best Practices Upgrade
- Attach acceptance criteria per problem: rendering mode, caching rule, failure behavior, and SEO expectation.
- Require at least one debug artifact per task (logs, timing output, or reproduction steps).
- Include explicit “what breaks if…” prompts for cache and boundary decisions.
- Keep solved tasks linked to interview explanations and mini-project implementation patterns.
