...
[Home](../../README.md) > 09_Databases > 04_mini_project
...
1. In this project, how do you design table boundaries and foreign key constraints to preserve domain integrity under real write concurrency?
2. What migration sequence would you use for introducing a major schema change while keeping old and new application versions running safely?
3. How would you validate correctness and performance of transactional workflows (inventory transfer, payment posting, order finalization)?
4. Which read paths in this project should use replicas or caches, and how do you manage replication lag implications?
5. What data retention and archival strategy would you define to keep operational tables performant over time?

### Production Best Practices Upgrade
- Treat mini-project schema as a living contract with explicit migration history, backward-compatibility windows, and owner accountability.
- Include seed data, load profiles, and replayable query benchmarks so performance claims are testable.
- Define operational dashboards for lock contention, long transactions, replication delay, and error-prone queries.
- Add rollback-safe deployment playbooks for schema + code changes, including dual-write/dual-read transition stages when needed.
- Validate backup/restore recovery objectives as part of project completion criteria, not post-project maintenance.
