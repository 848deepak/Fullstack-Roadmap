...
[Home](../../README.md) > 17_Monitoring_and_Logging > 04_mini_project
...
1. In this mini-project, what minimum observability stack is required before exposing users to traffic?
2. How do you define ownership boundaries for telemetry across frontend, backend, and infrastructure?
3. Which alerts should page immediately versus create ticketed follow-up work?
4. How do you verify dashboard health and runbook completeness as part of project delivery?
5. What evidence proves observability improvements reduced incident impact over time?

### Production Best Practices Upgrade
- Establish project-level SLOs and tie all alerts to explicit service objectives.
- Instrument critical user flows end-to-end with correlation context.
- Require runbook links and owner metadata for every paging alert.
- Include synthetic checks and canary metrics in release workflows.
- Run post-incident telemetry gap reviews and prioritize remediation actions.
