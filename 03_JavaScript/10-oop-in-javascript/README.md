...
## Overview
This module focuses specifically on object-oriented programming patterns in JavaScript.
...
## How to Run
```bash
node 01-constructor-functions.js
node 02-classes-inheritance.js
```

## Expected Outcome
You should be able to design class-based models and explain OOP principles in JavaScript context.

<!-- DOCS_UPGRADE_V2026_START -->
## Documentation Upgrade Layer

### Breadcrumb Navigation
[Home](../../README.md) > 03_JavaScript > 10-oop-in-javascript
...
- `03_JavaScript/10-oop-in-javascript/00-reference.md`
- `03_JavaScript/10-oop-in-javascript/01-constructor-functions.js`
- `03_JavaScript/10-oop-in-javascript/02-classes-inheritance.js`
- `03_JavaScript/10-oop-in-javascript/03-encapsulation-polymorphism-static.js`
