...
[Home](../../README.md) > 15_CI_CD > 04_mini_project
...
1. In this mini-project, how would you split CI/CD responsibilities across app, infra, and platform teams?
2. What release strategy would you choose for high-traffic endpoints versus low-risk background jobs?
3. How do you handle schema-change coordination within an automated deployment pipeline?
4. Which guardrails prove this project is safe for frequent production releases?
5. How would you evolve this delivery setup from one service to a multi-service platform?

### Production Best Practices Upgrade
- Define project release stages with measurable quality and reliability gates.
- Keep deployment automation idempotent and environment-aware.
- Add rollback rehearsals and migration rollback plans to project milestones.
- Require post-deploy validation and synthetic checks before completion.
- Maintain incident-oriented runbooks for pipeline and deployment failure modes.
