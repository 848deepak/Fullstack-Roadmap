...
[Home](../../README.md) > 15_CI_CD > 03_interview_questions
...
1. How do you explain progressive delivery and release governance to interview panels with mixed backgrounds?
2. What answer distinguishes mature understanding of CI flakiness versus transient infrastructure issues?
3. How would you justify adding or removing a manual approval gate in a regulated environment?
4. Which pipeline architecture choices reduce deployment risk for database-coupled services?
5. How do you discuss DORA metrics without optimizing for vanity outcomes?

### Production Best Practices Upgrade
- Organize question sets by feedback speed, release safety, governance, and recovery readiness.
- Include follow-up prompts that test incident response judgement, not memorized definitions.
- Tag each question with expected depth for mid-level versus senior candidates.
- Tie interview prompts to realistic trade-offs in multi-team delivery organizations.
- Refresh examples to reflect evolving CI/CD security and compliance expectations.
