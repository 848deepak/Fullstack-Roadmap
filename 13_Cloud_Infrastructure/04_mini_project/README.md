...
[Home](../../README.md) > 13_Cloud_Infrastructure > 04_mini_project
...
1. In this mini-project, what boundaries would you define between network, compute, and data stacks for safe iteration?
2. How do you design CI workflows that allow frequent infra changes while preserving deployment confidence?
3. Which cloud failures should this project treat as expected (quota, zone outage, IAM regression), and how?
4. How would you stage this project from sandbox to production with measurable promotion criteria?
5. What signals show this infrastructure is ready for real traffic rather than just successful provisioning?

### Production Best Practices Upgrade
- Define project milestones with environment gates (security review, cost check, and resiliency checks).
- Keep reusable modules and project wiring separate to avoid accidental coupling.
- Add disaster-recovery drills for state corruption and region-level partial outages.
- Require change windows and rollback plans for high-impact networking or IAM changes.
- Publish runbooks for provisioning failures, drift remediation, and emergency access.
