...
[Home](../../README.md) > 20_Production_Architecture > 04_mini_project
...
1. In this mini-project, what reliability gates are mandatory before exposing real user traffic?
2. How do you separate critical dependencies from optional dependencies in failover design?
3. Which rollback and degradation behaviors should be automated versus manually approved?
4. What evidence proves the project can recover from dependency outages within target objectives?
5. How would you evolve this project from single-region reliability to multi-region resilience?

### Production Best Practices Upgrade
- Define project reliability milestones with explicit promotion and rollback criteria.
- Tie deploy approvals to health budgets, dependency checks, and post-deploy validation.
- Run game-day rehearsals for top failure modes before production launch.
- Maintain runbooks with ownership, escalation paths, and recovery verification steps.
