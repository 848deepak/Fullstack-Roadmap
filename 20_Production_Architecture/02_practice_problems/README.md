...
[Home](../../README.md) > 20_Production_Architecture > 02_practice_problems
...
1. How would you sequence reliability exercises from single-service health checks to dependency-aware degradation?
2. Which practice scenarios best teach timeout-budget tuning without causing false positive alerts?
3. How should learners justify fail-open versus fail-closed behavior in user-facing endpoints?
4. What rubric should evaluate reliability solutions beyond “service stayed up” outcomes?
5. How do you design drills that reveal hidden coupling across retries, queues, and storage dependencies?

### Production Best Practices Upgrade
- Define each exercise with reliability objectives, failure assumptions, and measurable success criteria.
- Require participants to submit incident timelines and mitigation rationale, not only final fixes.
- Include chaos-style failure injections for latency spikes, dependency timeouts, and partial outages.
- Reuse common failure patterns as follow-up tasks to strengthen operational judgment.
