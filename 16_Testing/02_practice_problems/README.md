...
[Home](../../README.md) > 16_Testing > 02_practice_problems
...
1. How do you sequence testing exercises from deterministic units to realistic integration failures?
2. Which problems best teach boundary testing, property-based testing, and mutation thinking?
3. How should learners justify tests that are intentionally not automated?
4. What rubric differentiates strong test design from broad but shallow coverage?
5. How do you design practice prompts that surface flaky-test root causes?

### Production Best Practices Upgrade
- Define each exercise with risk category, expected confidence gain, and acceptable runtime.
- Require learners to explain scope, assumptions, and blind spots for their test choices.
- Include debugging tasks for flaky and nondeterministic tests.
- Provide reference solutions with trade-off commentary, not only expected outputs.
- Recycle common failure patterns into advanced follow-up exercises.
