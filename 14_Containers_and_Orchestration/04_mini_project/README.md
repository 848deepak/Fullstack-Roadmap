...
[Home](../../README.md) > 14_Containers_and_Orchestration > 04_mini_project
...
1. For this mini-project, how do you partition services into workloads, jobs, and platform dependencies?
2. Which rollout model would you use for API and worker components with different risk profiles?
3. How do you verify autoscaling decisions improve user outcomes instead of hiding inefficient code?
4. Which failure drills are mandatory before calling this project production-ready?
5. How would you evolve this project for multi-cluster or multi-region resilience?

### Production Best Practices Upgrade
- Define deployment stages with hard promotion criteria and automated rollback conditions.
- Separate app concerns from platform concerns in repository structure and ownership.
- Add smoke, load, and chaos checks to project release gates.
- Maintain runbooks for rollout failures, node pressure, and network policy regressions.
- Track change-failure rate and mean time to restore as project health indicators.
